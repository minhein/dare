(function (global, factory) {
  ...
  var script$3 = {
    ...
    data: function data() {
      var panels = ['date', 'year', 'month'];
      var panel = panels.indexOf(this.type) !== -1 ? this.type : 'date';
      return {
        panel: panel,
        innerCalendar: null
      };
  ...
  var CalendarRange = {
    ...
    watch: {
      value: {
        ...
        handler: function handler() {
          ...
          this.calendars = this.innerValue.map(function (v) {
            return getValidDate(v, _this.defaultValue);
          });
    ...
    methods: {
      ...
      getRangeClasses: function getRangeClasses(cellDate, currentDates, classes) {
  ...
  var script$8 = {
    ...
    methods: {
      ...
      parseDate: function parseDate(value, fmt) {
        ...
        var backupDate = getValidDate(this.defaultValue);
